...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(tblTareas, 1, 0, 1, 2);
        ...
        gridLayout->addWidget(txtTareaDescr, 2, 0, 1, 2);
        ...
        if (tblCateg->columnCount() < 2)
            tblCateg->setColumnCount(2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        tblCateg->setHorizontalHeaderItem(0, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        tblCateg->setHorizontalHeaderItem(1, __qtablewidgetitem4);
        ...
        tblEtiq->setHorizontalHeaderItem(0, __qtablewidgetitem5);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem4 = tblCateg->horizontalHeaderItem(1);
        ...
        QTableWidgetItem *___qtablewidgetitem5 = tblEtiq->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QApplication::translate("MainWindow", "Etiqueta", 0));
        ...
        menuEtiquetas->setTitle(QApplication::translate("MainWindow", "Eti&quetas", 0));
        menuArchivo->setTitle(QApplication::translate("MainWindow", "Archi&vo", 0));
    } // retranslateUi
